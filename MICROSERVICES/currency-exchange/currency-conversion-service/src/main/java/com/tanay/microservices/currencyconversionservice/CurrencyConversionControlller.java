...
public class CurrencyConversionControlller
{
    ...
    public CurrencyConversion calulateCurrencyConversion(@PathVariable String from,
    ...
    public CurrencyConversion calulateCurrencyConversionFeign(@PathVariable String from,
                                                         @PathVariable String to,
                                                         @PathVariable BigDecimal quantity)
    {
